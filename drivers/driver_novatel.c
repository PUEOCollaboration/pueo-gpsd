...
static gps_mask_t novatel_status(struct gps_device_t *session, an_packet_t* an_packet) {
  ...
  if (decode_status_packet(&status_packet, an_packet) == 0) {
    session->driver.novatel.system_status.r = status_packet.system_status;
    session->driver.novatel.filter_status.r = status_packet.filter_status;
    

    GPSD_LOG(LOG_PROG, &session->context->errout,
	     "NOVATEL: Status: System status:"
	     "  -- System failure %u"
	     ...
	     session->driver.novatel.system_status.b.system_failure,
	     session->driver.novatel.system_status.b.accelerometer_sensor_failure,
	     session->driver.novatel.system_status.b.gyroscope_sensor_failure,
	     session->driver.novatel.system_status.b.magnetometer_sensor_failure,
	     session->driver.novatel.system_status.b.pressure_sensor_failure,
	     session->driver.novatel.system_status.b.gnss_failure,
	     session->driver.novatel.system_status.b.accelerometer_over_range,
	     session->driver.novatel.system_status.b.gyroscope_over_range,
	     session->driver.novatel.system_status.b.magnetometer_over_range,
	     session->driver.novatel.system_status.b.pressure_over_range,
	     session->driver.novatel.system_status.b.minimum_temperature_alarm,
	     session->driver.novatel.system_status.b.maximum_temperature_alarm,
	     session->driver.novatel.system_status.b.internal_data_logging_error,
	     session->driver.novatel.system_status.b.high_voltage_alarm,
	     session->driver.novatel.system_status.b.gnss_antenna_fault,
	     session->driver.novatel.system_status.b.serial_port_overflow_alarm);

    GPSD_LOG(LOG_PROG, &session->context->errout,
	     "NOVATEL: Status: Filter status:"
	     ...
	     session->driver.novatel.filter_status.b.orientation_filter_initialised,
	     session->driver.novatel.filter_status.b.ins_filter_initialised,
	     session->driver.novatel.filter_status.b.heading_initialised,
	     session->driver.novatel.filter_status.b.utc_time_initialised,
	     session->driver.novatel.filter_status.b.gnss_fix_type,
	     session->driver.novatel.filter_status.b.event1_flag,
	     session->driver.novatel.filter_status.b.event2_flag,
	     session->driver.novatel.filter_status.b.internal_gnss_enabled,
	     session->driver.novatel.filter_status.b.dual_antenna_heading_active,
	     session->driver.novatel.filter_status.b.velocity_heading_enabled,
	     session->driver.novatel.filter_status.b.atmospheric_altitude_enabled,
	     session->driver.novatel.filter_status.b.external_position_active,
	     session->driver.novatel.filter_status.b.external_velocity_active,
	     session->driver.novatel.filter_status.b.external_heading_active);
  }
  else {
    GPSD_LOG(LOG_WARN, &session->context->errout,
	     "NOVATEL: Unix time: unable to decode");
...
static gps_mask_t novatel_position_standard_deviation(struct gps_device_t *session, an_packet_t* an_packet) {
  gps_mask_t mask = 0;
  ...
  if (decode_position_standard_deviation_packet(&position_standard_deviation_packet, an_packet) == 0) {
    ...
    GPSD_LOG(LOG_WARN, &session->context->errout,
	     "NOVATEL: Position standard deviation: unable to decode");
    return 0;
  }
...
static gps_mask_t novatel_euler_orientation_standard_deviation(struct gps_device_t *session, an_packet_t* an_packet) {
  gps_mask_t mask = 0;
  ...
  if (decode_euler_orientation_standard_deviation_packet(&euler_orientation_standard_deviation_packet, an_packet) == 0) {
    ...
    GPSD_LOG(LOG_PROG, &session->context->errout,
	     "NOVATEL: Euler attitude STD: roll %.5f pitch %.5f heading %.5f\n",
    ...
    GPSD_LOG(LOG_WARN, &session->context->errout,
	     "NOVATEL: Euler attitude STD: unable to decode");
    return 0;
  }
...
static gps_mask_t novatel_sensor_temperatures(struct gps_device_t *session, an_packet_t* an_packet) {
  gps_mask_t mask = 0;
  ...
  if (decode_sensor_temperatures_packet(&sensor_temperatures_packet, an_packet) == 0) {
    for (int i=0; i<3; i++) {
      session->driver.novatel.gyroscope_temperature[i] = sensor_temperature_packet->gyroscope_temperature[i];
      session->driver.novatel.accelerometer_temperature[i] = sensor_temperature_packet->accelerometer_temperature[i];   
    }
    session->driver.novatel.pressure_temperature = sensor_temperature_packet->pressure_sensor_temperature;

    GPSD_LOG(LOG_PROG, &session->context->errout,
	     "NOVATEL: Sensor temperatures (deg C): gyro %.1f %.1f %.1f"
	     " accel %.1f %.1f %.1f pressure %.1f\n",
	     session->driver.novatel.gyroscope_temperature[0],
	     session->driver.novatel.gyroscope_temperature[1],
	     session->driver.novatel.gyroscope_temperature[2],
	     session->driver.novatel.accelerometer_temperature[0],
	     session->driver.novatel.accelerometer_temperature[1],
	     session->driver.novatel.accelerometer_temperature[2],
	     session->driver.novatel.pressure_temperature);
  }
  else {
    GPSD_LOG(LOG_WARN, &session->context->errout,
	     "NOVATEL: Sensor temperatures: unable to decode");
    return 0;
  }
