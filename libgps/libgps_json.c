                         ...
                         const char **endptr)
{
    ...
    const struct json_attr_t json_attrs_1[] = {
        ...
        {"acc_z",     t_real,      .addr.real = &datap->acc_z,
         .dflt.real = NAN},
        {"acc_temp_x",     t_real,      .addr.real = &datap->acc_temp_x,
         .dflt.real = NAN},
        {"acc_temp_y",     t_real,      .addr.real = &datap->acc_temp_y,
         .dflt.real = NAN},
        {"acc_temp_z",     t_real,      .addr.real = &datap->acc_temp_z,
         .dflt.real = NAN},
        ...
        {"gyro_temp", t_real,      .addr.real = &datap->gyro_temp,
         .dflt.real = NAN},
	{"gyro_temp_x",t_real,   .addr.real = &datap->gyro_temp_x,
	 .dflt.real = NAN},
	{"gyro_temp_y",t_real,   .addr.real = &datap->gyro_temp_y,
	 .dflt.real = NAN},
	{"gyro_temp_z",t_real,   .addr.real = &datap->gyro_temp_z,
	 .dflt.real = NAN},
        ...
        {"heading",   t_real,      .addr.real = &datap->heading,
         .dflt.real = NAN},
        {"heading_std",   t_real,  .addr.real = &datap->heading_std,
         .dflt.real = NAN},
        ...
        {"pitch",     t_real,      .addr.real = &datap->pitch,
         .dflt.real = NAN},
        {"pitch_std",   t_real,    .addr.real = &datap->pitch_std,
         .dflt.real = NAN},
        {"roll_st",   t_character, .addr.character = &datap->roll_st},
        {"roll",      t_real,      .addr.real = &datap->roll,
         .dflt.real = NAN},
        {"roll_std",   t_real,     .addr.real = &datap->roll_std,
         .dflt.real = NAN},
        {"temp",      t_real,      .addr.real = &datap->temp,
         .dflt.real = NAN},
        {"antenna1_current",      t_real,      .addr.real = &datap->antenna1_current,
         .dflt.real = NAN},
        {"antenna2_current",      t_real,      .addr.real = &datap->antenna2_current,
         .dflt.real = NAN},
        {"pressure",      t_real,      .addr.real = &datap->pressure,
         .dflt.real = NAN},
