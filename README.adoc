...
This is the PUEO fork of gpsd. This will include support for some new devices, that will hopefully eventually be contributed upstream. 
It may also contain ABI changes that may not make it upstream. 
